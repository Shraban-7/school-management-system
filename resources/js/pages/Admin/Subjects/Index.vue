...
const filtered = computed(() => {
    if (!search.value) return props.subjects.data;
    const q = search.value.toLowerCase();
    return props.subjects.data.filter(
        (s) =>
                    ...
                    >
                        ...
                        >
                            <tr>
                                ...
                                <th class="px-4 py-3">Marks (Full/Pass)</th>
                        ...
                        >
                            ...
                            >
                                ...
                                <td class="px-4 py-3">{{ sub.class_level }}</td>
                                <td class="px-4 py-3">
                                    {{ sub.group_stream ?? '—' }}
                                </td>
                                <td class="px-4 py-3">
