...
const form = reactive({
    ...
    academic_session_id: props.syllabus.academic_session_id,
...
function submit() {
    router.post(
        `/admin/syllabus/${props.syllabus.id}`,
        {
            _method: 'put',
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2 space-y-2">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener"
                                    class="inline-flex items-center gap-1.5 text-sm text-accent-600 hover:underline dark:text-accent-400"
                                >
