    ...
    <div>
        ...
        <section class="bg-[#1e2875] text-[#f7f3e8]">
            <div class="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
                <p class="text-xs font-semibold tracking-[0.25em] text-[#c9a227] uppercase">Administration</p>
                <div class="mt-2 h-px w-16 bg-[#c9a227]" aria-hidden="true"></div>
                <h1 class="mt-5 font-serif text-3xl font-bold sm:text-4xl">Our Staff</h1>
            </div>
        </section>
                ...
                >
                    ...
                    <dl class="mt-4 space-y-2 border-t border-[#1e2875]/10 pt-4 text-sm">
                        <div v-if="person.subject_specialization">
                            <dt class="text-xs font-semibold text-[#1a1a1a]/50 uppercase">Area</dt>
